...
any_table <- function(data_frame,
    ...
    for (row_combi in rows){
        ...
        for (col_combi in columns){
            ...
            if (index == 1){
                name <- paste0("header_end_", paste(col_combi_vars, collapse = "%%%"))
                if (length(by) == 0){
                ...
                name <- paste0("header_size_", paste(col_combi_vars, collapse = "%%%"))
