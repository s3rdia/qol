...
set_graphic_options <- function(..., save_file = NULL){
    ...
    visuals <- c("font", "color_theme", "color_usage", "theme_override",
                 ...
                 "other_alignment", "reverse_colors", "reverse_segments",
                 ...
                 "legend_columns", "legend_symbol_size", "legend_reverse", "origin",
                 "tooltip_font_color", "tooltip_background_color",
                 "tooltip_border_color",
                 "tooltip_group_font_color", "tooltip_group_back_color",
