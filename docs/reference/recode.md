...
`recode.()`: If one variable is provided, returns a vector with recoded
values. If multiple variables are provided, returns a list of recoded
vectors which can be assigned to multiple new variables at once.
