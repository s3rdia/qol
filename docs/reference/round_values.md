...
This function rounds values according to DIN 1333 (round half up) or as
an alternative in multiples of a given value.
...
- new_names:
  ...
  The new names of the rounded variables. If provided adds variables, if
  not overwrites the existing variables with rounded values.
