...
[![DEVELOPMENT Version](https://img.shields.io/badge/GitHub-1.4.0-blue.svg)](https://github.com/s3rdia/qol)
...
Design graphics in a way, where the computer does the tedious and you the fun work. Make graphics look beautiful without complex programming. The main graphics function is modular, meaning with the help of the many mid level functions you can integrate your own custom graphic and make use of the many parameters.
