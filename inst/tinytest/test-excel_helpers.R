...
expect_message(my_style <- my_style |> modify_output_style(test = "Calibri"),
               " ! WARNING: Style element 'test' is invalid and will", info = "Add none existent element to style")
...
expect_message(my_num_fmt <- my_num_fmt |> modify_number_formats(test = 8),
               " ! WARNING: Number format 'test' is invalid and will", info = "Modfiy number format style")
