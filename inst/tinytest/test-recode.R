...
test_df2 <- test_df
test_df2[["age_group"]] <- suppressMessages(test_df2 |> recode(age = age.))
...
test_df2[["income_group"]] <- suppressMessages(test_df2 |> recode(income = income.))
...
test_df2 <- test_df
expect_message(test_df2[["income_group"]] <- test_df2 |> recode(income = income.), " X ERROR: Variable 'income' has NA values", info = "Recode interval values with NA values")
...
test_df2 <- test_df
expect_message(test_df2[["age_group"]] <- test_df2 |> recode(age = age1), " X ERROR: The format for 'age' must be a data table", info = "Providing none format data frames")
expect_message(test_df2[["age_group"]] <- test_df2 |> recode(age = age2), " X ERROR: The format for 'age' must be a data table", info = "Providing none format data frames")
...
test_df2 <- test_df
expect_message(test_df2[["age_group"]] <- test_df2 |> recode(dog = age.), " X ERROR: Variable 'dog' not found in the input data frame", info = "Given variable is not in data frame")
...
test_df2 <- test_df
expect_message(test_df2[["age_group"]] <- test_df2 |> recode(age = age.), " ! WARNING: The format for 'age' is a multilabel", info = "Recoding with multilabel gives a warning")
