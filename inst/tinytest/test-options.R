...
set_output(1)
expect_error(print_stack_as_messages("ERROR"), "Output can only be 'console', 'text', 'excel', 'excel_nostyle', 'html', 'excel_html' or 'no'. Global option remains unchanged.", info = "Abort setting global options on empty list")
